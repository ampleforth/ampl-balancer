...
contract('CRPFactory', async (accounts) => {
    ...
    describe('Factory', () => {
        ...
        let weth;
        let dai;
        let startWeights = [toWei('1'), toWei('39')];
        let startBalances = [toWei('80000'), toWei('40')];
        var blockRange;
        ...
        describe('configurableWeights only', () => {
            ...
            it('Controller should be able to call updateWeightsGradually() with valid range', async () => {
                ...
                let startBlock = block.number+3; // This number 6 was trial and error as I don't know how blocks are mined exactly
                let endBlock = startBlock + blockRange;
                let endWeights = [toWei('39'), toWei('1')];
