...
contract('Test Math', async () => {
    ...
    describe('Exact math', async () => {
        ...
        describe('mul', async () => {
            /* TODO This test fails! Returns 0?
            it('multiplies correctly', async () => {
                const a = new BN('1234');
                const b = new BN('5678');

                await testCommutative(bMath.bmul, a, b, a.mul(b));
            }); */
        ...
        describe('div', async () => {
            it('divides correctly', async () => {
                ...
                // TODO - this returns '1' as Wei, not a.div(b) (regular "1")
            ...
            /* TODO This test fails - returns decimal value, not complete number
            it('returns complete number result on non-even division', async () => {
                const a = new BN('7000');
                const b = new BN('5678');

                expect(await bMath.bdiv(a, b)).to.be.bignumber.equal('1');
            }); */
