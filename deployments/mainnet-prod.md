...
crpPool: "0x49F2befF98cE62999792Ec98D0eE4Ad790E7786F"
controller: "0x6723B7641c8Ac48a61F5f505aB1E9C03Bb44a301"
bPool: "0x7860E28ebFB8Ae052Bfe279c07aC5d94c9cD2937"
...
poolParams = {
  ...
  "tokenBalances": ["60000000000","40000000"],
...
# crpPool = await AmplElasticCRP.at("0x49F2befF98cE62999792Ec98D0eE4Ad790E7786F");
await crpPool.setController(deployer);
await crpPool.getController.call()

initialSupply = '100000000000000000000' // 100e18
minimumWeightChangeBlockPeriod = 10;
addTokenTimeLockInBlocks = 10;

ampl = await IERC20.at('0xD46bA6D942050d489DBd938a2C909A5d5039A161')
ampl.approve(crpPool.address, '100000000000000000000')

usdc = await IERC20.at('0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48')
usdc.approve(crpPool.address, '100000000000000000000')
...
0x0bbc687300000000000000000000000049f2beff98ce62999792ec98d0ee4ad790e7786f0000000000000000000000007860e28ebfb8ae052bfe279c07ac5d94c9cd2937000000000000000000000000d46ba6d942050d489dbd938a2c909a5d5039a161
```
